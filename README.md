...
![Installation Options](/images/software_install/arduino-1.8.2-windows_2017-05-08_15-33-38.png)
1. Leave the default installation Destination Folder unchanged and select `Install`  
![Installation Folder](/images/software_install/arduino-1.8.2-windows_2017-05-08_15-33-44.png)
1. Wait for the installation to complete. Toward the end of the installation, you may be prompted to install several drivers. Select `Install` for each prompt.  
    ...
    * Arduino USB Driver (from Arduino LLC)  
    ![Arduino USB Driver LLC](/images/software_install/rundll32_2017-05-08_15-34-52.png)
1. Click `Close` to complete the Arduino IDE installation  
  ![First Driver](/images/software_install/arduino-1.8.2-windows_2017-05-08_15-35-02.png)

## Configure Arduino IDE for ESP8266
1. Open the Arduino IDE and click on `File` → `Preferences`  
![Arduino Desktop Icon](/images/software_configuration/Arduino_Desktop_2017-05-08_15-48-38.png)  
![Arduino File Preferences](/images/software_configuration/Arduino_File_Preferences_2017-05-08_15-58-36.png)
...
![Arduino File Preferences](/images/software_configuration/Arduino_Boards_Manager_2017-05-08_15-54-16.png)  
...
![ESP8266 Package Installation](/images/software_configuration/BM_ESP8266_2017-05-08_16-06-06.png)  
